...
class SprainReasons extends StatefulWidget {
  const SprainReasons({Key? key}) : super(key: key);

  @override
  State<SprainReasons> createState() => _BruiseDefState();
}

class _BruiseDefState extends State<SprainReasons> {
  List<dynamic>? sprainDanger;
  List<dynamic>? sprainReasons;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: sprainReasons != null && sprainDanger != null
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ListView.separated(
                          ...
                          itemCount: sprainReasons!.length,
