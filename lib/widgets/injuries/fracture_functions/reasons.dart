...
class FractureReasons extends StatefulWidget {
  const FractureReasons({Key? key}) : super(key: key);

  @override
  State<FractureReasons> createState() => _BruiseDefState();
}

class _BruiseDefState extends State<FractureReasons> {
