...
class BruiseReasons extends StatefulWidget {
  const BruiseReasons({Key? key}) : super(key: key);

  @override
  State<BruiseReasons> createState() => _BruiseDefState();
}

class _BruiseDefState extends State<BruiseReasons> {
